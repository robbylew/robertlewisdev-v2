...
const base = 'https://robertlewis.dev'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @roberthedev\'s ${base}${route.path}\n\nI think...`)}`)
...
<template>
  ...
  <div v-if="route.path !== '/'" class="prose m-auto mt-8 mb-8 slide-enter animate-delay-500 print:hidden">
    ...
    <span font-mono op50>> </span>
    <RouterLink
      :to="route.path.startsWith('/posts/') ? '/blogs' : (route.path.split('/').slice(0, -1).join('/') || '/')"
